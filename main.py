...
while poker.get_winner() is None:
    ...
    if current_type is not None and current_player != current_type_player:
        print(f"current cards: {current_type}, other's hand cards remain {other_cards_number}")
    ...
    while not valid_input:
        try:
            ...
            print("Input error, input cards with a blank like '2 3 4'")
